 ...
 * @LastEditTime: 2026-04-20 23:43:30
 * @FilePath:assets/scripts/core/UIManager.ts
 * @Description: UI管理器
 */
...
export class UIManager {
    ...
    async open(uiName: string, layer: UILayer) {
        ...
        const prefab = await AssetManagerEx.inst.load<Prefab>(BundlesEnum.UI, uiName, Prefab);
    ...
    async close(uiName: string) {
        ...
        //释放资源
        AssetManagerEx.inst.release(BundlesEnum.UI, uiName);
